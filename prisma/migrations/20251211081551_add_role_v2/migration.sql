/*
  ...
  - You are about to drop the column `userRoleId` on the `Account` table. All the data in the column will be lost.
  - You are about to drop the column `accessToken` on the `Session` table. All the data in the column will be lost.
  - You are about to drop the column `userRoleId` on the `Session` table. All the data in the column will be lost.
...
INSERT INTO "new_user" ("createdAt", "email", "emailVerified", "id", "image", "name", "password", "twoFactorEnabled", "updatedAt") SELECT "createdAt", "email", "emailVerified", "id", "image", "name", "password", "twoFactorEnabled", "updatedAt" FROM "user";
DROP TABLE "user";
